...
class FilesGenerator {
  ...
  ReactDOM[window.g_useSSR ? 'hydrate' : 'render'](
    ...
    const validKeys = this.service.applyPlugins('addRuntimePluginKey', {
      initialValue: ['patchRoutes', 'render', 'rootContainer', 'modifyRouteProps', 'onRouteChange', 'modifyInitialProps', 'initialProps']
    });
...
window.g_initialData = \${require('${(0, _umiUtils.winPath)(require.resolve('serialize-javascript'))}')(props)};
              `.trim()
          }]
        });
    ...
    (0, _fs.writeFileSync)(paths.absLibraryJSPath, (0, _umiUtils.prettierFile)(`${entryContent.trim()}\n`), 'utf-8');
  }
...
__IS_BROWSER ? ${initialHistory} : require('history').createMemoryHistory()
    ...
    (0, _fs.writeFileSync)((0, _path.join)(paths.absTmpDirPath, 'history.js'), (0, _umiUtils.prettierFile)(`${content.trim()}\n`), 'utf-8');
  }
  ...
  generateRouterJS() {
    ...
    if (this.routesContent !== routesContent) {
      (0, _fs.writeFileSync)(absRouterJSPath, (0, _umiUtils.prettierFile)(`${routesContent.trim()}\n`), 'utf-8');
