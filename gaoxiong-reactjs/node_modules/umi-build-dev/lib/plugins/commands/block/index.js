...
var _default = api => {
  ...
  function _block() {
    _block = _asyncToGenerator(function* (args = {}) {
      ...
      switch (args._[0]) {
        case 'clear':
          yield (0, _clearGitCache.default)(args, api);
          break;
        ...
        case 'list':
          retCtx = yield (0, _util.getDefaultBlockList)(args, blockConfig, add);
          break;
  ...
  function _getCtx() {
    _getCtx = _asyncToGenerator(function* (url, args = {}) {
      debug(`get url ${url}`);
      const ctx = yield (0, _download.getParsedData)(url, _objectSpread({}, blockConfig, args));
  ...
  function _add() {
    _add = _asyncToGenerator(function* (args = {}) {
      ...
      const path = args.path,
            ...
            js = args.js,
            uni18n = args.uni18n;
      const ctx = yield getCtx(url, args);
      ...
      if (!path) {
        ...
        ctx.routePath = (0, _umiUtils.winPath)(path);
      } // fix demo => /demo
